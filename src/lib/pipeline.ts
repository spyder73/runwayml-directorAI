...
export function buildFallbackSceneOutlineFromBucket(bucket: StoryBucket) {
  ...
  return {
    scenes: usableSeeds.map((seed) => ({
      ...
      imagePrompt: `Cinematic atmosphere for a movie scene showing ${seed.visualSummary}. Shape the lighting, mood, lens, setting, and weather around the visual motif of ${motif}.`,
